...
from service_api.views import (
    IndexView,
    EducationalAndMethodicalWorkView,
    ScientificAndInnovativeWorkView,
    GenericReportDataView,
    ReportsView,
    OrganizationalAndEducationalWorkView,
    ReportPdf,
    pivot_report_by_type,
    TeachersReportView,
    HeadsOfDepartmentsReportView,
    FacultiesReportView,
    DecansReportView,
)
...
urlpatterns = [
    ...
    path(
        "fillin/educational-and-methodical-work/",
        EducationalAndMethodicalWorkView.as_view(),
        name="educational_and_methodical_work",
    ),
    path(
        "fillin/scientific-and-innovative-work/",
        ScientificAndInnovativeWorkView.as_view(),
        name="scientific_and_innovative_work",
    ),
    path(
        "fillin/organizational-and-educational-work/",
        OrganizationalAndEducationalWorkView.as_view(),
    ...
    path(
        "pivot-report/<int:report_period_id>/<str:level_type>/<int:pk>",
        pivot_report_by_type,
    ...
    path("csv_reports/teachers/<int:report_period_id>/", TeachersReportView.as_view(), name="teachers"),
    path(
        "csv_reports/head-of-departments/<int:report_period_id>/",
        HeadsOfDepartmentsReportView.as_view(),
        name="teachers",
    ),
    path("csv_reports/faculties/<int:report_period_id>/", FacultiesReportView.as_view(), name="teachers"),
    path("csv_reports/decans/<int:report_period_id>/", DecansReportView.as_view(), name="teachers"),
